...
function withAliases(tokens: TokenSeed): ColorTokens {
  return {
    ...tokens,
    bg: tokens.pageBg,
    borderLight: tokens.borderLight ?? tokens.border,
    accentHover: tokens.accentStrong,
    accentText: tokens.accentContrast,
...
function accentTokens(
  ...
  | 'accentText'
> {
  const softAlpha = mode === 'dark' ? 0.12 : 0.1;
  const ringAlpha = uiStyle === 'classic' ? 0.2 : 0.18;

  return {
    accent: family.accent,
    accentStrong: family.accentStrong,
    accentContrast: family.accentContrast,
    accentRing: alpha(family.accent, ringAlpha),
    accentSoft: alpha(family.accent, softAlpha),
    accentGlow: alpha(family.accent, 0.22),
    gradientPrimary: `linear-gradient(180deg, ${lighten(family.accent, 0.08)} 0%, ${family.accent} 55%, ${family.accentStrong} 100%)`,
    gradientPrimaryHover: `linear-gradient(180deg, ${lighten(family.accent, 0.12)} 0%, ${lighten(family.accent, 0.06)} 55%, ${family.accent} 100%)`,
    gradientPrimaryActive: `linear-gradient(180deg, ${family.accentStrong} 0%, ${darken(family.accentStrong, 0.05)} 100%)`,
...
export const lightColors: ColorTokens = withAliases({
  ...
  syntaxAttr: '#A13E3B',
  gradientPrimary: 'linear-gradient(180deg, #2D3A4A 0%, #2D3A4A 55%, #1E2A36 100%)',
  gradientPrimaryHover: 'linear-gradient(180deg, #334257 0%, #2D3A4A 55%, #1E2A36 100%)',
  ...
  transitionControl: 'background-color 170ms ease, border-color 170ms ease, color 170ms ease, box-shadow 170ms ease, transform 170ms ease',
...
export const darkColors: ColorTokens = withAliases({
  ...
  syntaxAttr: '#FFAAA5',
  gradientPrimary: 'linear-gradient(180deg, #4D6478 0%, #4D6478 55%, #3D5164 100%)',
  gradientPrimaryHover: 'linear-gradient(180deg, #587186 0%, #4D6478 55%, #3D5164 100%)',
...
export const classicLightColors: ColorTokens = withAliases({
  ...
  syntaxBoolean: '#6c43b8',
  syntaxAttr: '#a13e3b',
  gradientPrimary: 'linear-gradient(180deg, #21824a 0%, #21824a 55%, #1d7341 100%)',
  gradientPrimaryHover: 'linear-gradient(180deg, #23854e 0%, #22834c 55%, #1f7845 100%)',
  gradientPrimaryActive: 'linear-gradient(180deg, #1d7341 0%, #196a3a 100%)',
  shadowPrimaryButton: 'inset 0 1px 0 rgb(255 255 255 / 18%), 0 2px 8px rgb(33 130 74 / 25%), 0 0 16px var(--color-accent-glow)',
  shadowPrimaryButtonHover: 'inset 0 1px 0 rgb(255 255 255 / 22%), 0 4px 12px rgb(33 130 74 / 30%), 0 0 20px var(--color-accent-glow)',
  shadowPrimaryButtonActive: 'inset 0 1px 0 rgb(255 255 255 / 10%), 0 1px 4px rgb(33 130 74 / 22%)',
  shadowCard: '0 1px 2px rgb(35 31 24 / 4%), 0 8px 24px rgb(35 31 24 / 6%)',
  shadowCardHover: '0 2px 4px rgb(35 31 24 / 5%), 0 12px 28px rgb(35 31 24 / 9%)',
  shadowBar: '0 1px 2px rgb(35 31 24 / 4%), 0 4px 16px rgb(35 31 24 / 3%)',
  shadowTabActive: 'inset 0 1px 0 rgb(255 255 255 / 55%), 0 1px 2px rgb(35 31 24 / 6%)',
...
export const classicDarkColors: ColorTokens = withAliases({
  ...
  syntaxBoolean: '#c7a2ff',
  syntaxAttr: '#ffaaa5',
  gradientPrimary: 'linear-gradient(180deg, #95e0a7 0%, #87d99b 55%, #79cf8e 100%)',
  ...
  shadowPrimaryButton: 'inset 0 1px 0 rgb(255 255 255 / 12%), 0 2px 8px rgb(0 0 0 / 30%), 0 0 16px var(--color-accent-glow)',
  shadowPrimaryButtonHover: 'inset 0 1px 0 rgb(255 255 255 / 16%), 0 4px 12px rgb(0 0 0 / 35%), 0 0 20px var(--color-accent-glow)',
  shadowPrimaryButtonActive: 'inset 0 1px 0 rgb(255 255 255 / 8%), 0 1px 4px rgb(0 0 0 / 30%)',
  ...
  shadowTabActive: 'inset 0 1px 0 rgb(255 255 255 / 10%), 0 1px 2px rgb(0 0 0 / 25%)',
...
> = {
  modern: {
    light: {
      green: { accent: '#21824a', accentStrong: '#1a6638', accentContrast: '#FFFFFF' },
      blue: { accent: '#2a79f3', accentStrong: '#1a64d0', accentContrast: '#FFFFFF' },
      orange: { accent: '#de8b23', accentStrong: '#b8721c', accentContrast: '#FFFFFF' },
      purple: { accent: '#7b44da', accentStrong: '#6433b5', accentContrast: '#FFFFFF' },
      red: { accent: '#d53e3e', accentStrong: '#b32e2e', accentContrast: '#FFFFFF' },
      teal: { accent: '#17a398', accentStrong: '#128078', accentContrast: '#FFFFFF' },
      cyan: { accent: '#1298d8', accentStrong: '#0d7ab0', accentContrast: '#FFFFFF' },
      pink: { accent: '#d43f86', accentStrong: '#b0326e', accentContrast: '#FFFFFF' },
      yellow: { accent: '#d6a828', accentStrong: '#b08a20', accentContrast: '#1e1400' },
    },
    dark: {
      green: { accent: '#21824a', accentStrong: '#1a6638', accentContrast: '#FFFFFF' },
      blue: { accent: '#2a79f3', accentStrong: '#1a64d0', accentContrast: '#FFFFFF' },
...
export function getBaseTokens(mode: AppThemeMode, uiStyle: UiStyle): ColorTokens {
  if (uiStyle === 'classic') {
...
export function applyAccent(
  colors: ColorTokens,
  accent: string,
  mode: AppThemeMode = colors === darkColors || colors === classicDarkColors ? 'dark' : 'light',
  uiStyle: UiStyle = colors === classicLightColors || colors === classicDarkColors ? 'classic' : 'modern',
): ColorTokens {
